...
public class SilantroPylon : MonoBehaviour {
	...
	[HideInInspector]public FireCondition fireCondition = FireCondition.Normal;
	...
	[HideInInspector]public float openTime = 5;
	// ----------------------------------------------------------------------------------------------------------------------------------------------------------
...
public class PylonEditor: Editor
{
	...
	public override void OnInspectorGUI ()
	{
		...
		if (pylon.munitionType == SilantroPylon.OrdnanceType.Missile) {
			...
			GUILayout.Space(3f);
			pylon.fireCondition = (SilantroPylon.FireCondition)EditorGUILayout.EnumPopup("Fire Condition", pylon.fireCondition);
			if(pylon.fireCondition == SilantroPylon.FireCondition.Overide)
			{
				GUILayout.Space(3f);
				pylon.openTime = EditorGUILayout.FloatField("Wait Time", pylon.openTime);
			}
		}
		//
