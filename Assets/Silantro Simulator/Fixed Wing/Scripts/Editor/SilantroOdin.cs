...
public class SilantroOdin : MonoBehaviour {
	...
	public class SilantroMenu
	{
		...
		private static void AddCannon()
		{
			...
			AudioClip end = (AudioClip)AssetDatabase.LoadAssetAtPath ("Assets/Silantro Simulator/Fixed Wing/Sounds/Default/Weapons/Minigun/Browning End.wav",typeof(AudioClip));
			AudioClip loop = (AudioClip)AssetDatabase.LoadAssetAtPath ("Assets/Silantro Simulator/Fixed Wing/Sounds/Default/Weapons/Minigun/Browning Loop.wav",typeof(AudioClip));
			minigun.fireLoopSound = loop;minigun.fireEndSound = end;
			//
		...
		{
			Application.OpenURL("https://www.youtube.com/playlist?list=PLJkxX6TkFwO9Eaf8ENRYJkoxPnv41s75v");
		}
	}
}